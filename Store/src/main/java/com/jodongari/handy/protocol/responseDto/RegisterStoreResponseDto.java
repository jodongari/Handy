...
public class RegisterStoreResponseDto {
    ...
    public RegisterStoreResponseDto(StoreEntity storeEntity) {
        this.seq = storeEntity.getSeq();
        this.ownerSeq = storeEntity.getOwnerSeq();
        this.name = storeEntity.getName();
        this.businessReportCardImage = storeEntity.getBusinessReportCardImage();
        this.businessLicenseImage = storeEntity.getBusinessLicenseImage();
        ...
        this.logo = storeEntity.getLogo();
        this.backgroundImage = storeEntity.getBackgroundImage();
